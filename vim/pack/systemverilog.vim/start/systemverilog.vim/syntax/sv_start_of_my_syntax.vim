...
syn keyword svUserFunctionsExcept4 mailbox semaphore real realtime event reg wire integer logic bit time byte chandle genvar signed unsigned shortint shortreal string void int specparam contained
