...
syn match svUserFunctions ".*\(function\|task\).*\s[a-zA-Z]\+[a-zA-Z0-9_\.]\+;"me=e-1 contains=svUserFunctionsExcept21,svUserFunctionsExcept22
...
syn keyword svUserFunctionsExcept22 mailbox semaphore real realtime event reg wire integer logic bit time byte chandle genvar signed unsigned shortint shortreal string void int specparam contained
